...
public class IndexFiles {
     ...
     * files and directories found under the given directory. NOTE: This method indexes one document
     * per input file. This is slow. For good throughput, put multiple documents into your input
     * file(s). An example of this is in the benchmark module, which can create "line doc" files,
